  ...
  ({ className, variant, size, ...props }, ref) => {
    return (
      <button
        ...
        relative overflow-hidden inline-flex items-center justify-center rounded-md text-lg font-bold z-20
      ...
      >
        <span
          className={`absolute inset-0 bg-primary-blue transition-transform duration-300 ease-in 
          translate-y-[101%] ${
        ...
        <span
          {...props}
          className="transition-transform duration-300 ease-in translate-y-0"
        />
      </button>
    );
  }
